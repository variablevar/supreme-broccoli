      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-foreground/60 max-w-2xl mx-auto mb-10 leading-relaxed">
            Imnoshi provides access to advanced GPU mining infrastructure operated by the Imnoshi team. Our LLM-based Smart Mining technology optimises performance and infrastructure efficiency. Your dedicated device provides clear daily visibility into the earnings generated by your infrastructure.
          </p>
