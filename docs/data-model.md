...
- Purchase inquiries: requester contact details, bounded device quantity, fixed quoted device price, processing status and timestamps. The public endpoint returns no stored record; admin status changes are atomic and audited.
